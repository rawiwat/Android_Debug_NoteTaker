...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val observer = Observer<ArrayList<Note>> { notes ->
            if (notes != null) {
                if (listAdapter == null) {
                    listAdapter = NoteListAdapter(notes, activity as MainActivity)
        ...
        viewModel!!.getNotesList(context as MainActivity)?.observe(this, observer)
        ...
        if (resultCode == Activity.RESULT_OK) {
            if (requestCode == EDIT_REQUEST_CODE) {
                if (data != null) {
                    ...
                    viewModel!!.addNote(returnedNote, this)
                }
            }
        }
    }
